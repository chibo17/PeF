...
class LinkedList:
    ...
    def mult(self):
        if self.next == None:
            return self.item
        return self.item * self.next.mult() 
    ...
    def zip(self, l):
        if self.next == None or l.next == None:
            result = LinkedList((self.item, l.item))
            return result
        result = self.next.zip(l.next)
        n = LinkedList((self.item, l.item))
        n.next = result
        return n
